...
Code from Will Pearse: "Programming fror Biologists" course
...
data <- data.frame(na.omit(extract(r)))
...
plotTree(pteridaceaeClade.tre,ftype="i",cex=0.6, fsize=0.4, offset=1, type="up")
